...
public class DBActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        typeEditor = (EditText)findViewById(R.id.type);
        ingridientEditor = (EditText)findViewById(R.id.ing);
    ...
    public void onInsertClick(View view) {
        db.open();
        db.insertCookie(
                nameEditor.getText().toString(), typeEditor.getText().toString(), ingridientEditor.getText().toString());
        //--get all cookies---
        String cookiesContent = "";
        Cursor c = db.getAllCookies();
        if (c.moveToFirst())
